<?php @session_start();
 ...
 di tulis oleh : CITRA
 */
unset($_SESSION['wisnu_938']);
if (ISSET($_SESSION['wisnu_938']))
 {
...
<table width="400" border="1">
  ...
  <tr>
    ...
    <td width="275"><input name="wisnu_938" type="text" id="wisnu_938" /></td>
  </tr>
  <tr>
    <td><span class="style4">Password</span></td>
    <td><span class="style4">:</span></td>
    <td><input name="201" type="password" id="wisnu_938" /></td>
  </tr>
  <tr>
